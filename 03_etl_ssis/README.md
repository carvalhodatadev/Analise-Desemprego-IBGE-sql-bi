...
### 1. Control Flow
![Control Flow do Pacote SSIS](https://raw.githubusercontent.com/carvalhodatadev/Analise-Desemprego-IBGE-sql-bi/main/03_etl_ssis/screenshots/01_control_flow.PNG)
*Orquestração das tarefas do pacote: extração, transformação e carga*

### 2. Data Flow
![Data Flow do Pacote SSIS](https://raw.githubusercontent.com/carvalhodatadev/Analise-Desemprego-IBGE-sql-bi/main/03_etl_ssis/screenshots/02_data_flow.PNG)
*Detalhamento das transformações aplicadas aos dados durante o ETL*

### 3. Resultados da Execução
![Resultados da Execução](https://raw.githubusercontent.com/carvalhodatadev/Analise-Desemprego-IBGE-sql-bi/main/03_etl_ssis/screenshots/03_execution_results.PNG)
*Análise dos dados após processamento - 92 registros em stage e DW*

### 4. Confirmação de Sucesso
![Confirmação de Sucesso](https://raw.githubusercontent.com/carvalhodatadev/Analise-Desemprego-IBGE-sql-bi/main/03_etl_ssis/screenshots/04_success_confirmation.PNG)
