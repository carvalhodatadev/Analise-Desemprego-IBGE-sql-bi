...
## 🔗 Links Úteis
- [IBGE - PNAD Contínua](https://www.ibge.gov.br/estatisticas/sociais/trabalho/9171-pnad-continua.html)
- [SIDRA IBGE - Tabela 4099](https://sidra.ibge.gov.br/tabela/4099)
- [Documentação Metodológica](https://biblioteca.ibge.gov.br/visualizacao/livros/liv101844.pdf)

## 📁 Arquivos Nesta Pasta
- `README.md` - Esta documentação
- `02_METADADOS.md` - Documentação técnica detalhada
- `03_dados_exemplo.csv` - Exemplo da estrutura dos dados
- `04_dados_excel_brutos.png` - Print dos dados no Excel
- `05_fonte_ibge_pagina.png` - Print da página inicial do IBGE
- `06_fonte_ibge_selecao.png` - Print da seleção no site do IBGE
